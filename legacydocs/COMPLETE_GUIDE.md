...
│  user.nix: usuario ravn, home-manager                          │
└─────────────────────────────────────────────────────────────────┘
                            ↓
┌────────────────────────┬────────────────────────────────────────┐
...
```bash
sudo nixos-rebuild switch --flake /home/ravn/dotfiles#hydenix
```
...
#### `user.nix`
**¿Qué es?** Configuración del usuario `ravn` en este PC.
...
**Diferencia clave:**
- `hm/` = Configuración del usuario ravn (dotfiles, programas de usuario)
...
# Copiar a tu repo
scp hardware-configuration.nix ravn@host:~/dotfiles/hosts/mi-vm/
```
