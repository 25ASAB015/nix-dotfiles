  ...
  # FOLLOW THE BELOW INSTRUCTIONS LINE BY LINE TO SET UP YOUR SYSTEM
{
  ...
  hydenix = {
    ...
    hostname = "dominus"; # REQUIRED: Set your computer's network name (change to something unique)
    timezone = "America/El_Salvador"; # REQUIRED: Set timezone (examples: "America/New_York", "Europe/London", "Asia/Tokyo")
