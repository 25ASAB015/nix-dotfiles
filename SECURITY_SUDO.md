...
1. **Acceso físico a tu PC**
   ...
   sudo userdel ludus  # Borra tu usuario
...
[sudo] password for ludus: ****  # ← Pides contraseña
...
sudo nixos-rebuild switch
[sudo] password for ludus: ****  # ← Pides contraseña otra vez
```
...
security.sudo = {
  ...
  extraConfig = ''
    ...
    ludus ALL=(ALL) PASSWD: DANGEROUS
    
    # Todo lo demás sin contraseña
    ludus ALL=(ALL) NOPASSWD: ALL, !DANGEROUS
  '';
};
```
