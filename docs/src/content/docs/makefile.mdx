...
- `make build`: Solo compila, no activa nada
...
#### `make benchmark`
Mide el tiempo que tarda un build completo de la configuración.

```bash
make benchmark
# ════════════════════════════════════════════════════════
#           ⏱️  Build Performance Benchmark          
# ════════════════════════════════════════════════════════
# 
# Measuring build time for configuration...
# This will perform a full build without applying changes.
# 
# [build output...]
# 
# ════════════════════════════════════════════════════════
...
**Cuándo usarlo:**
- Medir performance: comparar tiempos de build entre diferentes configuraciones
- Optimización: identificar si cambios afectan el tiempo de build
- Debugging: detectar builds inusualmente lentos
- Documentación: registrar tiempos de build para referencia

**Nota:** Este comando realiza un build completo sin aplicar cambios, similar a `make build` pero con medición de tiempo.
...
`list-hosts`, `hosts-info`, `search`, `search-installed`, `benchmark`, `repl`, `shell`, `vm`, `closure-size`
