...
4. **Workflow de lectura:** Junto con comandos como `make readme` o `make tutorial`, forma parte de un flujo de trabajo para acceder rápidamente a la documentación desde la terminal sin necesidad de abrir un navegador o editor.
...
**Relación con otros comandos:**
- `make readme` - Abre el README directamente
- `make tutorial` - Abre el tutorial del Makefile
...
`update`, `update-nixpkgs`, `update-hydenix`, `update-input`, `update-info`, `diff-update`, `upgrade`, `show`, `flake-check`, `diff-flake`

### Generaciones y Rollback (6)
`list-generations`, `rollback`, `diff-generations`, `diff-gen`, `generation-sizes`, `current-generation`

### Git y Respaldo (7)
`git-add`, `git-commit`, `git-push`, `git-status`, `git-diff`, `save`, `backup`
...
### Reportes y Exportación (4)
`git-log`, `export-config`, `export-minimal`

### Plantillas y Otros (6)
`new-host`, `new-module`, `hardware-scan`, `fix-permissions`, `fix-git-permissions`
