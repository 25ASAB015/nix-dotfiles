...
### `make quick`
Quick rebuild (skip checks) - más rápido pero menos seguro.

```bash
make quick
```

**Cuándo usarlo:** Cambios pequeños y confiables donde quieres velocidad.
...
### Cambios Importantes
```bash
make validate → make safe-switch
```
