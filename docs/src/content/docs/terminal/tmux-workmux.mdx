...
Tmux está instalado por defecto en tu configuración de usuario ([`hosts/hydenix/user.nix`](file:///home/ravn/Dotfiles/hosts/hydenix/user.nix)) y configurado con **Oh my tmux!**, un framework de configuración moderno y visualmente atractivo.
...
Para personalizar tu configuración, edita [`modules/hm/programs/terminal/tmux.conf.local`](file:///home/ravn/Dotfiles/modules/hm/programs/terminal/tmux.conf.local).
...
La configuración reside en [`modules/hm/programs/terminal/sesh.nix`](file:///home/ravn/Dotfiles/modules/hm/programs/terminal/sesh.nix). Aquí tienes ejemplos de sesiones configuradas con iconos y comandos de inicio:
