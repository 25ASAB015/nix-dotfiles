...
Para mantener tus dotfiles, submodules y el sistema actualizados en un solo paso, usa el comando unificado:
...
2. La sincronización de `oh-my-tmux.conf`.
3. La actualización de los inputs del flake de Nix.
4. La aplicación de la nueva configuración al sistema.
