    ...
    └── hm/
        ...
        └── programs/
            └── editors/
                ...
                ├── vscode.nix         # Módulo VS Code (extensiones)
                ├── cursor.nix         # Módulo Cursor (documentativo)
                └── antigravity.nix    # Módulo AntiGravity (documentativo)
```
...
**Ubicación del módulo**: `modules/hm/programs/editors/cursor.nix`
...
**Ubicación del módulo**: `modules/hm/programs/editors/antigravity.nix`
